        ...
        <Container maxWidth="fixed" sx={{justifyContent:'center'}} className="meteor-bg">
            <Grid container sx={{mt:5}}>
                ...
                <Grid item xs={12} md={6} sx={{border:'1.2px solid var(--gray)', p:2, borderRadius:'0.4em'}}>
                    ...
                    <Typography><b>Github Repository:</b> <a href="https://github.com/CrozzaX" target="_blank" rel="noreferrer" style={{color:'var(--indigo)'}}>SkyClub India</a></Typography>
                    <Typography><b>Developed by:</b> <a href="https://github.com/CrozzaX" target="_blank" rel="noreferrer" style={{color:'var(--indigo)'}}>Ritish Kumar</a></Typography>
