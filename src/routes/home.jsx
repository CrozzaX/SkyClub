      ...
      <div className="worldmap-bg" style={{padding: '5%'}}>
        <Container maxWidth="sm" sx={{textAlign: 'center', mt: '5%'}}>
            ...
            <div style={{marginTop:'8%'}}>
              ...
              <Button onClick={() => {window.location.href="https://github.com/CrozzaX/SkyClub"}} className="gray-btn" sx={{ml:2, px: '7%'}}>Github &nbsp; <ArrowForwardIosIcon sx={{fontSize: '0.8rem'}} /></Button>
            </div>
